...
static int st54j_se_probe(struct spi_device *spi)
{
	...
	struct spi_exynos_ctrl_data *spi_param;
	...
	spi->bits_per_word = 8;
	// NOTE: Qualcomm processor set the cs-delay to 90 clock-cycles. This
	// corresponds to 11.25 us for a SPI-clock running at 8 MHz. This is to
	// satisfy the 10 us nSS setup time when the ST54 comes out of standby mode.
	// TODO: Configure Exynos (or applicable AP) to manually pause for
