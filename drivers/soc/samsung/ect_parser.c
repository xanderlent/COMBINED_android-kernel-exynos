...
static ssize_t ect_create_binary_store(struct class *class,
...
static CLASS_ATTR_WO(ect_create_binary);
...
static int ect_dump_init(void)
{
	...
	if (class_create_file(ect_class, &class_attr_ect_create_binary)) {
