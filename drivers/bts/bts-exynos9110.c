...
static struct trex_info trex_snode[] = {
	{ .pa_base = EXYNOS9110_PA_S_NRT0, },
	{ .pa_base = EXYNOS9110_PA_RT_MEM0, },
	{ .pa_base = EXYNOS9110_PA_CP_MEM0, },
};

static struct bts_info exynos_bts[] = {
	[BTS_IDX_CPUCL0] = {
		.name = "cpucl0",
		.pa_base = EXYNOS9110_PA_CPUCL0,
		.type = BT_TREX,
		.enable = true,
	...
	[BTS_IDX_DPU] = {
		.name = "dpu",
		.pa_base = EXYNOS9110_PA_DPU,
		.type = BT_TREX,
		.enable = true,
		.table[BS_DEFAULT].stat.scen_en = true,
		.table[BS_DEFAULT].stat.priority = 0xA,
		.table[BS_DEFAULT].stat.rmo = 0x12,
	...
	[BTS_IDX_MFCMSCL] = {
		...
		.table[BS_CAMERA_DEFAULT].stat.scen_en = true,
		.table[BS_CAMERA_DEFAULT].stat.priority = 0x4,
		.table[BS_CAMERA_DEFAULT].stat.rmo = 0xC,
		.table[BS_CAMERA_DEFAULT].stat.wmo = 0xC,
		.table[BS_CAMERA_DEFAULT].stat.max_rmo = 0x1,
		.table[BS_CAMERA_DEFAULT].stat.max_wmo = 0x1,
	},
	[BTS_IDX_IS] = {
		.name = "is",
		.pa_base = EXYNOS9110_PA_IS,
		.type = BT_TREX,
		.enable = true,
		.table[BS_DEFAULT].stat.scen_en = true,
		.table[BS_DEFAULT].stat.priority = 0xC,
...
static struct drex_info exynos_drex[] = {
	[DREX_IDX_0] = {
		.name = "drex0",
		.pa_base = EXYNOS9110_PA_DREX0,
		.enable = true,
		.table[BS_DEFAULT].stat.scen_en = true,
		.table[BS_DEFAULT].stat.write_flush_config[0] = 0x50100C02,
		.table[BS_DEFAULT].stat.write_flush_config[1] = 0x1008100A,
...
static struct drex_pf_info exynos_drex_pf[] = {
	[DREX_PF_IDX_0] = {
		.name = "drex0_pf",
		.pa_base = EXYNOS9110_PA_DREX0_PF,
		.enable = true,
		.table[BS_DEFAULT].stat.scen_en = true,
		.table[BS_DEFAULT].stat.pf_rreq_thrt_con = 0x00008000,
		.table[BS_DEFAULT].stat.allow_mo_for_region = 0x00000000,
		.table[BS_DEFAULT].stat.pf_qos_timer[0] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[1] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[2] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[3] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[4] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[5] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[6] = 0x00070007,
		.table[BS_DEFAULT].stat.pf_qos_timer[7] = 0x00070007,
	},
};
