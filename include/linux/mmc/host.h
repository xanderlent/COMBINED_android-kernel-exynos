...
#define MMC_CAP_RUNTIME_RESUME  (1 << 26)
...
#define MMC_CAP2_SKIP_INIT_SCAN	(1 << 28)       /* skip init mmc scan */
#define MMC_CAP2_SKIP_INIT_NOT_TRAY	(1 << 29)	/* Skip init when to not tray detect */
