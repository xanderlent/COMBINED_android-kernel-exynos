...
#define DSS_LOG_S2D_SIZE		(20 * SZ_1M)
...
#define DSS_LOG_KERNEL_ADDR	(DSS_HEADER_ADDR + DSS_HEADER_SIZE)
#define DSS_LOG_PLATFORM_ADDR	(DSS_LOG_KERNEL_ADDR + DSS_LOG_KERNEL_SIZE)
#define DSS_LOG_S2D_ADDR	(DSS_LOG_PLATFORM_ADDR + DSS_LOG_PLATFORM_SIZE)
...
#define DSS_LOG_PSTORE_ADDR	(DSS_LOG_ARRAYPANIC_ADDR + DSS_LOG_ARRAYPANIC_SIZE)
#define DSS_LOG_KEVENTS_ADDR	(DSS_LOG_PSTORE_ADDR + DSS_LOG_PSTORE_SIZE)
#define DSS_LOG_FATAL_ADDR	(DSS_LOG_KEVENTS_ADDR + DSS_LOG_KEVENTS_SIZE)
