...
static int cod9005x_dmic_capture_init(struct snd_soc_component *codec)
{
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
static int cod9005x_dmic_capture_deinit(struct snd_soc_component *codec)
{
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
/*
static int cod9005x_mute_mic(struct snd_soc_component *codec, bool on)
{
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
static void cod9005x_adc_mute_work(struct work_struct *work)
{
	...
	struct snd_soc_component *codec = cod9005x->codec;
...
static int cod9005x_regulators_enable(struct snd_soc_component *codec)
{
	int ret;
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
static void cod9005x_regulators_disable(struct snd_soc_component *codec)
{
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
static void cod9005x_reg_restore(struct snd_soc_component *codec)
{
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
static void cod9005x_codec_remove(struct snd_soc_component *codec)
{
	struct cod9005x_priv *cod9005x = snd_soc_component_get_drvdata(codec);
...
static struct snd_soc_component_driver soc_codec_dev_cod9005x = {
		...
		const struct i2c_device_id *id)
{
	...
	ret = snd_soc_register_component(&i2c->dev, &soc_codec_dev_cod9005x,
