...
/* lihongshuai@20190405 add for tp_info */
...
/* ['h5000_0914], [32'h0000_0000], ISP control, ISPCTL */
#define BOOT_INIT_FIN		(0x00000001 << 31)
#define CRC_TRIG		(0x00000001 << 7)
#define FLH_READ_TRIG		(0x00000001 << 6)
#define FLH_RELEASE_PD		(0x00000001 << 5)
#define FLH_POWER_DOWN	(0x00000001 << 4)
#define FLASH_WRT_READY	(0x00000001 << 3)
#define FLASHWRITE_TRIG	(0x00000001 << 2)
#define SECTOR_ERA_TRG		(0x00000001 << 1)
#define BLOCK_ERA_TRG		(0x00000001 << 0)
/* Enable sysfs */
...
extern unsigned char raydium_mem_table_setting(struct raydium_ts_data *ts);
...
extern unsigned char raydium_id_init(struct raydium_ts_data *ts,
