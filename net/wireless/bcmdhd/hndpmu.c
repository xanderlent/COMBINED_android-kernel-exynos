...
static uint32 si_pmu_cpu_pll7clock(si_t *sih, osl_t *osh);
#endif
...
static rsc_per_chip_t rsc_4368 = {RES4368_HT_AVAIL, RES4368_MACPHY_MAIN_CLK_AVAIL,
		...
		NO_SUCH_RESOURCE, RES4368_CORE_RDY_CB, RES4368_CORE_RDY_DIG};
...
static const char BCMATTACHDATA(rstr_pwr_opt_dis)[] = "pwr_opt_dis";
#endif
...
static const pmu_res_updown_t BCMATTACHDATA(bcm4387c0_res_updown)[] = {
	...
	{RES4387_XTAL_HQ,		0x00210021},
	{RES4387_XTAL_PU,		0x03e80033},
	{RES4387_PWRSW_DIG,	        0x00a200c2},
	{RES4387_PWRSW_AUX,	        0x0678046A},
	{RES4387_PWRSW_SCAN,	        0x00F20112},
	{RES4387_PWRSW_MAIN,	        0x0678046A},
	{RES4387_CORE_RDY_CB,		0x000a0033},
	{RES4387_PWRSW_CB,		0x006400ca},
};

static const pmu_res_subst_trans_tmr_t BCMATTACHDATA(bcm4387c0_res_subst_trans_tmr)[] = {
	{RES4387_PWRSW_DIG,		0, 0x00a20092},
	{RES4387_PWRSW_DIG,		1, 0x0052005a},
	{RES4387_PWRSW_DIG,		2, 0x00320052},
	{RES4387_PWRSW_DIG,		3, 0x00020002},

	{RES4387_PWRSW_AUX,		0, 0x0678045A},
	{RES4387_PWRSW_AUX,		1, 0x02900202},
	{RES4387_PWRSW_AUX,		2, 0x023001A2},
	{RES4387_PWRSW_AUX,		3, 0x00A00002},

	{RES4387_PWRSW_MAIN,		0, 0x0678045A},
	{RES4387_PWRSW_MAIN,		1, 0x02900202},
	{RES4387_PWRSW_MAIN,		2, 0x023001A2},
	{RES4387_PWRSW_MAIN,		3, 0x00A00002},

	{RES4387_PWRSW_SCAN,		0, 0x00F200E2},
	{RES4387_PWRSW_SCAN,		1, 0x00A2005A},
	{RES4387_PWRSW_SCAN,		2, 0x00820052},
...
#endif /* SAVERESTORE */
		/* NOTE: this block is to be removed once NEWT no longer needs 4368a0 */
...
BCMINITFN(si_pmu1_cpuclk0)(si_t *sih, osl_t *osh, pmuregs_t *pmu)
{
	...
	if (BCM4369_CHIP(sih->chip) || BCM4362_CHIP(sih->chip) ||
		...
		if (BCM4368_CHIP(sih->chip)) {
			ndiv_frac =
				(tmp & PMU4368_PLL1_PC5_NDIV_FRAC_MASK) >>
...
/**
 * BCM4368/4369/4378/4387 specific function returning the CPU clock frequency.
...
si_pmu_get_bb_vcofreq(si_t *sih, osl_t *osh, int xtalfreq)
{
	...
	} else if ((CHIPID(sih->chip) == BCM4368_CHIP_ID) || /* No Host interface strapping */
		0) {
		reg = si_pmu_pllcontrol(sih, PMU_PLL_CTRL_REG2, 0, 0);
		ndiv_int = reg >> 23;
		ndiv_mode = (reg >> 20) & 7;
...
si_pmu_cpu_pll7clock(si_t *sih, osl_t *osh)
{
	...
	fastclk = ((clk_ctl_st & CCS_ARMFASTCLOCKREQ) != 0);
...
{
	uint en_reg, val_reg;
	uint32 en_shift, en_mask, en_val, val_shift, val_mask;
