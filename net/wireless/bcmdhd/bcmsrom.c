...
#if defined(BCMINTERNAL) || defined(WLTEST) || defined (DHD_SPROM) || defined (BCMDBG)
#include <sbsprom.h>
#endif
...
#endif /* defined(BCMINTERNAL) || defined(WLTEST) || defined (DHD_SPROM) || defined (BCMDBG) */
#endif /* BCMSDIO */
#if !defined(BCMDONGLEHOST)
#ifdef BCMSPI
...
#if (!defined(BCMDONGLEHOST) && defined(BCMINTERNAL)) || \
	(!defined(BCMDONGLEHOST) && defined(BCMHOSTVARS))
...
static uint8 BCMATTACHDATA(defcis4368)[] = { 0x20, 0x4, 0xd0, 0x2, 0x64, 0x43, 0xff, 0xff };
	...
	char **vars, uint *varsz)
{
	...
	case BCM4368_CHIP_GRPID: ciss = 1; defcis = defcis4368; hdrsz = 4; break;
