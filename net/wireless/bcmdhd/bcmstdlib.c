...
static int
__atolx(char *buf, char * end, unsigned long num, unsigned long radix, int width,
...
CONST char BCMRODATA_ONTRAP(warn_str)[] = "RO overwritten %p\n";
CONST char BCMRODATA_ONTRAP(time_str)[] = "%06u.%03u ";
#endif /* DONGLEBUILD */
