...
#define BCM_DMA_HWA_TXSUPPORT		0x00000040	/* HWA managed tx */
#define BCM_DMA_HWA_RXSUPPORT		0x00000080	/* HWA managed rx */
...
int dma_txfast_hwa(hnddma_t *dmah, void *p0, uint chain_ndesc);
...
void dma_hwa_resource_reclaim(hnddma_t *dmah);
uint dma_hwa_get_enqueued_pkt_cnt(hnddma_t *dmah);
...
void * dma_peeknexttxp_hwa(hnddma_t *dmah, txd_range_t range);
...
#define DD_IS_SHARED_HWA_POOL(di) ((di)->dmactrlflags & DMA_CTRL_HWA_DD_POOL)
